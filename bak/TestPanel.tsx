  ...
  return (
    <main className="flex-1 p-8 overflow-auto">
      ...
      <section className="mb-8">
        <h2 className={`mb-4 ${isDark ? 'text-white' : 'text-neutral-900'}`}>初始化</h2>
      ...
      {/* 项目测试 */}
      <section className="mb-8">
        <h2 className={`mb-4 ${isDark ? 'text-white' : 'text-neutral-900'}`}>项目测试</h2>
      ...
      {/* 应用设置 */}
      <section>
        <h2 className={`mb-4 ${isDark ? 'text-white' : 'text-neutral-900'}`}>应用设置</h2>
